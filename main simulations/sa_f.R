...
sa1 <- sa1 + geom_point(data = data_vr, aes(x=log(gentime), y=scen_1_sa), color="#B40F20", alpha=0.5)
sa1
...
sj1 <- ggplot(data_vr, aes(x=log(gentime), y=scen_2_sj))+
  ...
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12))
sj1 <- sj1 + geom_point(data = data_vr, aes(x=log(gentime), y=scen_1_sj), color="#B40F20", alpha=0.5)
sj1
...
ta1 <- ggplot(data_vr, aes(x=log(gentime), y=scen_2_ta))+
  ...
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12))
ta1 <- ta1 + geom_point(data = data_vr, aes(x=log(gentime), y=scen_1_ta), color="#B40F20", alpha=0.5)
ta1
...
f1 <- ggplot(data_vr, aes(x=log(gentime), y=scen_2_f))+
  ...
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12))
f1 <- f1 + geom_point(data = data_vr, aes(x=log(gentime), y=scen_1_f), color="#B40F20", alpha=0.5)
f1
